...
const FirstPage = () => {
  ...
  return (
    <div className="box d-lg-flex">
      <div
        ref={ref}
        className="purpleDiv pb-3 pb-lg-0"
        style={{ backgroundColor: "#4831d4" }}
      >
        <motion.div
          variants={{
          ...
          className="d-flex flex-column gap-5 fullstack"
        >
          <div>
            <h1 style={{ color: "#ccf381" }} className="display-2 fw-bold mb-2">
              Full-Stack <br />
              Web Developer
            </h1>
            <h4
              className="lh-base name"
              style={{ color: "rgb(223, 223, 223)" }}
            >
              I'm <span style={{ color: "#ccf381" }}>Fasasi Foyin John</span>. A
              talented full-stack web developer
            </h4>
          </div>
          <div className="d-flex justify-content-between">
            <div style={{ width: "40%" }}>
              <p className="heading" style={{ color: "#ccf381" }}>
                Highly skilled at building responsive applications that meet
                client's requirement.
              </p>
            </div>
            <div style={{ width: "40%" }}>
              <p className="heading" style={{ color: "#ccf381" }}>
                Experienced at building robust backend architecture to fetch
      ...
      <div
        className="greenDiv position-relative"
        style={{ backgroundColor: "#ccf381" }}
      >
        <div className="d-flex d-lg-block justify-content-center position-relative py-5 py-lg-0">
          <div className="image">
            <Image
        ...
        <div
          ...
          style={{ width: "300px", height: "300px", top: "15%", right: "0" }}
        >
          <Image
            className="w-100 h-100"
            style={{ objectFit: "cover" }}
            src="https://res.cloudinary.com/dbxvk3apv/image/upload/v1686828167/samples/bg-pattern-intro-right-desktop_ibs6zm.svg"
          />
        </div>
      </div>
    </div>
